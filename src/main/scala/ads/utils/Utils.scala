...
import com.google.api.ads.adwords.axis.v201509.o._
import com.google.api.ads.adwords.lib.client.AdWordsSession
import com.google.api.ads.adwords.lib.client.reporting.ReportingConfiguration
import com.google.api.ads.adwords.lib.jaxb.v201509.DownloadFormat
import com.google.api.ads.adwords.lib.selectorfields.v201509.cm.{AdGroupCriterionField, AdGroupField, DataField}
...
object Utils {
  ...
  def estimates(adWordsServices: AdWordsServices, session: AdWordsSession, key: String) {
    ...
    import com.google.api.ads.adwords.axis.v201509.cm.{Keyword, KeywordMatchType, Language, Location, Money}
    import com.google.api.ads.adwords.axis.v201509.o.{AdGroupEstimateRequest, CampaignEstimateRequest, KeywordEstimateRequest, TrafficEstimatorSelector, TrafficEstimatorServiceInterface}
  ...
  def downloadReports(session: AdWordsSession, reportFile: String) {
    import com.google.api.ads.adwords.lib.client.reporting.ReportingConfiguration
    import com.google.api.ads.adwords.lib.jaxb.v201509.{DownloadFormat, ReportDefinition, ReportDefinitionDateRangeType, ReportDefinitionReportType, Selector}
    import com.google.api.ads.adwords.lib.utils.ReportDownloadResponseException
    import com.google.api.ads.adwords.lib.utils.v201509.ReportDownloader
  ...
  def getMoreKeywords(keyword: String, adWordsServices: AdWordsServices, session: AdWordsSession) = {
    ...
    val relatedToQuerySearchParameter = new RelatedToQuerySearchParameter();
    relatedToQuerySearchParameter.setQueries(Array[String] {
      keyword
    });
  ...
  def createAdGroup(name: String, campaignId: Long, adWordsServices: AdWordsServices, session: AdWordsSession) = {
    ...
    operation.setOperator(Operator.ADD);
    val operations = Array[AdGroupOperation] {
      operation
    }
    // Add ad groups.
